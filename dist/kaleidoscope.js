...
var Kaleidoscope = /** @class */ (function () {
    ...
    function Kaleidoscope(settings) {
        this.options = null;
        this.defaults = {
    ...
    Kaleidoscope.prototype.initializeCanvas = function () {
    ...
    // Register event listeners.
    Kaleidoscope.prototype.initializeEvents = function () {
        // TODO: for resize.
    };
    // Initialize the pipe.
    Kaleidoscope.prototype.initializePipe = function () {
        this.pipe = new Pipe(this.context, this.options);
    };
    // Initialize the particle storage.
    Kaleidoscope.prototype.initializeStorage = function () {
        this.storage = [];
