        ...
        Particle.prototype.draw = function () {
            ...
            switch (this.shape) {
                ...
                case 'drop':
                    ...
                    context.quadraticCurveTo(this.x, this.y + this.size / 3, this.x + this.size / 3, this.y);
                    context.quadraticCurveTo(this.x + this.size * (2 / 3), this.y + this.size * (1 / 3), this.x + this.size * (2 / 3), this.y + this.size * (2 / 3));
                    context.arc(this.x + this.size * (1 / 3), this.y + this.size * (2 / 3), this.size * (1 / 3), 0, Math.PI, false);
                    context.closePath();
                    context.fill();
                    context.restore();
                    break;
